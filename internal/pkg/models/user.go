...
var UserRels = struct {
	UIDSelfContacts  string
	UIDOtherContacts string
	UIDMessages      string
	UIDUserChats     string
}{
	UIDSelfContacts:  "UIDSelfContacts",
	UIDOtherContacts: "UIDOtherContacts",
	UIDMessages:      "UIDMessages",
	UIDUserChats:     "UIDUserChats",
}

// userR is where relationships are stored.
type userR struct {
	UIDSelfContacts  ContactSlice  `boil:"UIDSelfContacts" json:"UIDSelfContacts" toml:"UIDSelfContacts" yaml:"UIDSelfContacts"`
	UIDOtherContacts ContactSlice  `boil:"UIDOtherContacts" json:"UIDOtherContacts" toml:"UIDOtherContacts" yaml:"UIDOtherContacts"`
	UIDMessages      MessageSlice  `boil:"UIDMessages" json:"UIDMessages" toml:"UIDMessages" yaml:"UIDMessages"`
	UIDUserChats     UserChatSlice `boil:"UIDUserChats" json:"UIDUserChats" toml:"UIDUserChats" yaml:"UIDUserChats"`
}
...
// UIDSelfContacts retrieves all the contact's Contacts with an executor via uid_self column.
func (o *User) UIDSelfContacts(mods ...qm.QueryMod) contactQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`contact`.`uid_self`=?", o.UID),
...
// UIDOtherContacts retrieves all the contact's Contacts with an executor via uid_other column.
func (o *User) UIDOtherContacts(mods ...qm.QueryMod) contactQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`contact`.`uid_other`=?", o.UID),
		qmhelper.WhereIsNull("`contact`.`deleted_at`"),
	)
...
// UIDMessages retrieves all the message's Messages with an executor via uid column.
func (o *User) UIDMessages(mods ...qm.QueryMod) messageQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
// UIDUserChats retrieves all the user_chat's UserChats with an executor via uid column.
func (o *User) UIDUserChats(mods ...qm.QueryMod) userChatQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
// LoadUIDSelfContacts allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUIDSelfContacts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`contact`),
		qm.WhereIn(`contact.uid_self in ?`, args...),
		qmhelper.WhereIsNull(`contact.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	...
	if singular {
		object.R.UIDSelfContacts = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &contactR{}
			}
			foreign.R.UIDSelfUser = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.UID == foreign.UIDSelf {
				local.R.UIDSelfContacts = append(local.R.UIDSelfContacts, foreign)
				if foreign.R == nil {
					foreign.R = &contactR{}
				}
				foreign.R.UIDSelfUser = local
				break
			}
		}
	}
...
// LoadUIDOtherContacts allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUIDOtherContacts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`contact`),
		qm.WhereIn(`contact.uid_other in ?`, args...),
		qmhelper.WhereIsNull(`contact.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	...
	if singular {
		object.R.UIDOtherContacts = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &contactR{}
			}
			foreign.R.UIDOtherUser = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.UID == foreign.UIDOther {
				local.R.UIDOtherContacts = append(local.R.UIDOtherContacts, foreign)
				if foreign.R == nil {
					foreign.R = &contactR{}
				}
				foreign.R.UIDOtherUser = local
				break
			}
		}
	}
...
// LoadUIDMessages allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUIDMessages(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`message`),
		qm.WhereIn(`message.uid in ?`, args...),
		qmhelper.WhereIsNull(`message.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	...
	if singular {
		object.R.UIDMessages = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &messageR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.UID == foreign.UID {
				local.R.UIDMessages = append(local.R.UIDMessages, foreign)
				if foreign.R == nil {
					foreign.R = &messageR{}
				}
...
// LoadUIDUserChats allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUIDUserChats(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`user_chat`),
		qm.WhereIn(`user_chat.uid in ?`, args...),
		qmhelper.WhereIsNull(`user_chat.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	...
	if singular {
		object.R.UIDUserChats = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &userChatR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.UID == foreign.UID {
				local.R.UIDUserChats = append(local.R.UIDUserChats, foreign)
				if foreign.R == nil {
					foreign.R = &userChatR{}
				}
				foreign.R.UIDUser = local
...
// AddUIDSelfContactsG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UIDSelfContacts.
// Sets related.R.UIDSelfUser appropriately.
// Uses the global database handle.
func (o *User) AddUIDSelfContactsG(ctx context.Context, insert bool, related ...*Contact) error {
	return o.AddUIDSelfContacts(ctx, boil.GetContextDB(), insert, related...)
}

// AddUIDSelfContacts adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UIDSelfContacts.
// Sets related.R.UIDSelfUser appropriately.
func (o *User) AddUIDSelfContacts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Contact) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.UID, rel.UIDSelf, rel.UIDOther}
	...
	if o.R == nil {
		o.R = &userR{
			UIDSelfContacts: related,
		}
	} else {
		o.R.UIDSelfContacts = append(o.R.UIDSelfContacts, related...)
	}
...
// AddUIDOtherContactsG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UIDOtherContacts.
// Sets related.R.UIDOtherUser appropriately.
// Uses the global database handle.
func (o *User) AddUIDOtherContactsG(ctx context.Context, insert bool, related ...*Contact) error {
	return o.AddUIDOtherContacts(ctx, boil.GetContextDB(), insert, related...)
}

// AddUIDOtherContacts adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UIDOtherContacts.
// Sets related.R.UIDOtherUser appropriately.
func (o *User) AddUIDOtherContacts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Contact) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UIDOther = o.UID
	...
	if o.R == nil {
		o.R = &userR{
			UIDOtherContacts: related,
		}
	} else {
		o.R.UIDOtherContacts = append(o.R.UIDOtherContacts, related...)
	}
	...
	for _, rel := range related {
		if rel.R == nil {
			...
			rel.R.UIDOtherUser = o
		}
	}
	return nil
}

// AddUIDMessagesG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UIDMessages.
// Sets related.R.UIDUser appropriately.
// Uses the global database handle.
func (o *User) AddUIDMessagesG(ctx context.Context, insert bool, related ...*Message) error {
	return o.AddUIDMessages(ctx, boil.GetContextDB(), insert, related...)
}

// AddUIDMessages adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UIDMessages.
// Sets related.R.UIDUser appropriately.
func (o *User) AddUIDMessages(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Message) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UID = o.UID
			...
			values := []interface{}{o.UID, rel.Mid}
	...
	if o.R == nil {
		...
		o.R.UIDMessages = append(o.R.UIDMessages, related...)
	}
...
// AddUIDUserChatsG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UIDUserChats.
// Sets related.R.UIDUser appropriately.
// Uses the global database handle.
func (o *User) AddUIDUserChatsG(ctx context.Context, insert bool, related ...*UserChat) error {
	return o.AddUIDUserChats(ctx, boil.GetContextDB(), insert, related...)
}

// AddUIDUserChats adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UIDUserChats.
// Sets related.R.UIDUser appropriately.
func (o *User) AddUIDUserChats(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserChat) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UID = o.UID
			...
			values := []interface{}{o.UID, rel.UID, rel.Cid}
	...
	if o.R == nil {
		o.R = &userR{
			UIDUserChats: related,
		}
	} else {
		o.R.UIDUserChats = append(o.R.UIDUserChats, related...)
	}
...
func FindUserG(ctx context.Context, uID int, selectCols ...string) (*User, error) {
	return FindUser(ctx, boil.GetContextDB(), uID, selectCols...)
}

// FindUser retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindUser(ctx context.Context, exec boil.ContextExecutor, uID int, selectCols ...string) (*User, error) {
	userObj := &User{}
...
func UserExistsG(ctx context.Context, uID int) (bool, error) {
	return UserExists(ctx, boil.GetContextDB(), uID)
}

// UserExists checks if the User row exists.
func UserExists(ctx context.Context, exec boil.ContextExecutor, uID int) (bool, error) {
	var exists bool
