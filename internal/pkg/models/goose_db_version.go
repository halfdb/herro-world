...
func (q gooseDBVersionQuery) OneG() (*GooseDBVersion, error) {
	return q.One(boil.GetDB())
}

// One returns a single gooseDBVersion record from the query.
func (q gooseDBVersionQuery) One(exec boil.Executor) (*GooseDBVersion, error) {
	o := &GooseDBVersion{}
...
func (q gooseDBVersionQuery) AllG() (GooseDBVersionSlice, error) {
	return q.All(boil.GetDB())
}

// All returns all GooseDBVersion records from the query.
func (q gooseDBVersionQuery) All(exec boil.Executor) (GooseDBVersionSlice, error) {
...
func (q gooseDBVersionQuery) CountG() (int64, error) {
	return q.Count(boil.GetDB())
}

// Count returns the count of all GooseDBVersion records in the query.
func (q gooseDBVersionQuery) Count(exec boil.Executor) (int64, error) {
	var count int64
...
func (q gooseDBVersionQuery) ExistsG() (bool, error) {
	return q.Exists(boil.GetDB())
}

// Exists checks if the row exists in the table.
func (q gooseDBVersionQuery) Exists(exec boil.Executor) (bool, error) {
	var count int64
...
func FindGooseDBVersionG(iD uint64, selectCols ...string) (*GooseDBVersion, error) {
...
func FindGooseDBVersion(exec boil.Executor, iD uint64, selectCols ...string) (*GooseDBVersion, error) {
	...
	err := q.Bind(nil, exec, gooseDBVersionObj)
	if err != nil {
		if errors.Cause(err) == sql.ErrNoRows {
			return nil, sql.ErrNoRows
		}
	...
	if err = gooseDBVersionObj.doAfterSelectHooks(exec); err != nil {
...
func (o *GooseDBVersion) InsertG(columns boil.Columns) error {
	return o.Insert(boil.GetDB(), columns)
}

// Insert a single record using an executor.
// See boil.Columns.InsertColumnSet documentation to understand column list inference for inserts.
func (o *GooseDBVersion) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
...
func (o *GooseDBVersion) UpdateG(columns boil.Columns) (int64, error) {
...
func (o *GooseDBVersion) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	var err error
...
func (q gooseDBVersionQuery) UpdateAllG(cols M) (int64, error) {
	return q.UpdateAll(boil.GetDB(), cols)
}

// UpdateAll updates all rows with the specified column values.
func (q gooseDBVersionQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o GooseDBVersionSlice) UpdateAllG(cols M) (int64, error) {
	return o.UpdateAll(boil.GetDB(), cols)
}

// UpdateAll updates all rows with the specified column values, using an executor.
func (o GooseDBVersionSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
...
func (o *GooseDBVersion) UpsertG(updateColumns, insertColumns boil.Columns) error {
...
func (o *GooseDBVersion) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
...
func (o *GooseDBVersion) DeleteG() (int64, error) {
	return o.Delete(boil.GetDB())
}

// Delete deletes a single GooseDBVersion record with an executor.
// Delete will match against the primary key column to find the record to delete.
func (o *GooseDBVersion) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
...
func (q gooseDBVersionQuery) DeleteAllG() (int64, error) {
	return q.DeleteAll(boil.GetDB())
}

// DeleteAll deletes all matching rows.
func (q gooseDBVersionQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
...
func (o GooseDBVersionSlice) DeleteAllG() (int64, error) {
	return o.DeleteAll(boil.GetDB())
}

// DeleteAll deletes all rows in the slice, using an executor.
func (o GooseDBVersionSlice) DeleteAll(exec boil.Executor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
...
func GooseDBVersionExistsG(iD uint64) (bool, error) {
	return GooseDBVersionExists(boil.GetDB(), iD)
}

// GooseDBVersionExists checks if the GooseDBVersion row exists.
func GooseDBVersionExists(exec boil.Executor, iD uint64) (bool, error) {
	var exists bool
